(ns rd-management.advisor
  "RDAdvisor — proposes a research-and-development-management operation
  (coordinate a project task, review project status, approve a
  hazardous-material experiment protocol, release research data) for a
  registered project. The advisor is swappable: `mock-advisor`
  ...
  of project provenance or hazmat/data-release risk;
  `rd-management.governor` is the independent system that decides
  whether the proposal may proceed, per the itonami actor pattern.

  A proposal is a map:
    {:op :coordinate|:review|:approve-hazmat-protocol|:release-research-data
...
(def ^:private system-prompt
  "You are a research-and-development-management advisor. Given an R&D
